...
public class AdminUserController {
	...
	public String index(@RequestParam(name = "keyword", required = false) String keyword,
		...
		if(keyword != null && !keyword.isEmpty()) {
			userpPage = userService.findUserByNameLikeOrFuriganaLike(keyword, keyword, pageable);
		}else {
			userpPage = userService.findAllUsers(pageable);
		}
		
		model.addAttribute("userPage", userpPage);
